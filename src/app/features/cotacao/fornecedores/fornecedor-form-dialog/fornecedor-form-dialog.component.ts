...
@Component({
  ...
  template: `
    ...
    <mat-dialog-content>
      <div class="form-grid">
        ...
        <mat-form-field appearance="outline" class="full">
          ...
          <input matInput [(ngModel)]="form.nome" name="nome" required placeholder="Ex: Segurança Total Ltda." />
        </mat-form-field>

        <mat-form-field appearance="outline">
          <mat-label>E-mail *</mat-label>
          <mat-icon matPrefix>mail_outline</mat-icon>
          <input matInput [(ngModel)]="form.email" name="email" type="email" required placeholder="contato@fornecedor.com" />
        </mat-form-field>
        ...
        <mat-form-field appearance="outline">
          ...
          <input matInput [(ngModel)]="form.whatsapp" name="whatsapp" placeholder="(61) 99999-0000" />
        </mat-form-field>
    ...
    <mat-dialog-actions align="end">
      ...
      <button mat-flat-button color="primary" (click)="salvar()" [disabled]="!form.nome || !form.email">
  ...
  styles: [`
    ...
    .cat-chip {
      ...
      &.selected { border-color: #11BF7F; background: rgba(16,185,129,0.08); color: #0DA66E; font-weight: 600; }
    }
  `]
})
export class FornecedorFormDialogComponent {
  ...
  constructor(
    ...
    if (this.form.categorias) {
      this.form.categorias.split(',').filter(Boolean).forEach(k => this.selectedCats.add(k.trim()));
    }
  }

  isCatSelected(key: string): boolean { return this.selectedCats.has(key); }
