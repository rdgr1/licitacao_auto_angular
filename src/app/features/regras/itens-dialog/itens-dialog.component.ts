...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, MatDialogModule, MatButtonModule, MatTableModule, CurrencyPipe],
  template: `
    ...
    <mat-dialog-content>
      @if (data.itens.length === 0) {
        ...
        <table mat-table [dataSource]="data.itens" class="itens-table">
          ...
          <ng-container matColumnDef="unitario">
            ...
            <td mat-cell *matCellDef="let i">{{ i.valorUnitarioEstimado | currency:'BRL':'symbol':'1.2-2':'pt-BR' }}</td>
          </ng-container>
          <ng-container matColumnDef="total">
            <th mat-header-cell *matHeaderCellDef>Total</th>
            <td mat-cell *matCellDef="let i"><strong>{{ i.valorTotal | currency:'BRL':'symbol':'1.2-2':'pt-BR' }}</strong></td>
          </ng-container>
  ...
  `,
  styles: [`.itens-table { width: 100%; min-width: 600px; } mat-dialog-content { max-height: 70vh; overflow: auto; }`]
})
