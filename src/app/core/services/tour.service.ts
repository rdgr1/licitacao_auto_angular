...
const STEPS: TourStep[] = [
  {
    ...
    descricao:
      'Selecione as fontes (DODF, DOU) e uma data ou período. Clique em "Disparar Busca" para coletar leads automaticamente.',
    posicao: 'right',
    rota: '/leads',
  },
  {
    ...
    descricao:
      'Cada lead é uma oportunidade de licitação identificada automaticamente. Clique num lead para ver detalhes e avaliar se vale a pena.',
    posicao: 'top',
    rota: '/leads',
  },
  {
    ...
    titulo: 'Pipeline',
    descricao:
      'Acompanhe o ciclo de vida de cada oportunidade — desde a avaliação inicial até o processo licitatório completo.',
    posicao: 'top',
    rota: '/pipeline',
  },
  {
    ...
    titulo: 'Editais',
    descricao:
      'Acesse os editais completos das licitações monitoradas. Filtre por órgão, valor e status.',
    posicao: 'top',
    rota: '/editais',
  },
  {
    ...
    titulo: 'Notificações',
    descricao:
      'Você é avisado em tempo real quando novos leads são encontrados. O sino mostra quantos há para revisar.',
    posicao: 'bottom',
  },
  {
    ...
    descricao:
      'Clique no seu avatar para acessar configurações, gerenciar fontes de busca e preferências de notificação.',
    posicao: 'bottom',
  },
];
...
export class TourService {
  ...
  encerrar(): void {
    ...
    // Não existe campo tourCompleted em nenhum DTO real do backend — o controle é 100% local.
